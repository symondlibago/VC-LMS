...
const InputGroup = ({ label, value, onChange, placeholder = "", type = "text" }) => (
  <div className="space-y-1">
    ...
    <input
      ...
      className="w-full px-3 py-2 border border-gray-200 bg-gray-50 rounded-lg text-sm text-gray-900 focus:bg-white focus:ring-2 focus:ring-[#991b1b]/20 focus:border-[#991b1b] outline-none transition-all"
    />
  </div>
);
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col">
        <div className="px-6 py-5 bg-[#7f1d1d] flex justify-between items-center text-white shrink-0">
          <div>
